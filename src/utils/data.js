...
export const DUMMY_RESUME_DATA = {
  ...
  contactInfo: {
    email: "adeerahman@gmail.com",
    phone: "+6285697815931",
    location: "Bogor, Indonesia",
    linkedin: "https://linkedin.com/in/Aderah",
    github: "https://github.com/Adeerahman",
    website: "https://youtu.be/c_61lyKtseI?si=2hDQ9C1kZ1RDTLZM",
  },
  workExperience: [
    {
      company: "Pt Ayara Beuty Indonesia",
      role: "Staff Produksi",
      startDate: "2020-01",
      endDate: "2021-10",
      description:
  ...
  projects: [
    {
      ...
      description:
        "ply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.",
      github: "https://github.com/Adeerahman/prescription-manager",
    },
    {
      title: "Campaign Management",
      description:
        "ply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.",
      liveDemo: "https://github.com/Adeerahman/campaign-manager",
    },
    {
      title: "Analytics Dashboard",
      description:
        "ply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.",
      github: "https://github.com/Adeerahman/analytics-dashboard",
  ...
  languages: [
    ...
    { name: "Japan", progress: 70 },
    { name: "Sunda Pride", progress: 40 },
  ],
